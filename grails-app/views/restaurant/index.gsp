		...
		<div id="list-restaurant" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="venueId" title="${message(code: 'restaurant.venueId.label', default: 'Venue Id')}" />
				...
				<g:each in="${restaurantInstanceList}" status="i" var="restaurantInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${restaurantInstance.id}">${fieldValue(bean: restaurantInstance, field: "venueId")}</g:link></td>
